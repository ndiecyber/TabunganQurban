        ...
        <div class="flex justify-between items-start">
          ...
          <div class="flex flex-col items-end gap-1.5">
            ...
            <span class="text-[10px] font-bold text-gray-400 flex items-center">
              <span class="text-sm mr-1">{{ shohibul.type === 'sapi' ? '🐄' : '🐐' }}</span> {{ shohibul.type === 'sapi' ? 'Sapi' : 'Kambing' }}
            </span>
          </div>
        </div>
        ...
        <div class="space-y-1.5 pt-1">
          <div class="flex justify-between items-end">
            <div class="flex items-center gap-1.5">
              ...
              <span v-if="getPendingAmount(shohibul.id) > 0" class="text-[9px] font-bold text-amber-700 dark:text-amber-400 bg-amber-100 dark:bg-amber-950/40 px-1.5 py-0.5 rounded-md flex items-center">
                <ClockIcon class="w-2.5 h-2.5 mr-0.5" /> +{{ formatRp(getPendingAmount(shohibul.id)) }}
              </span>
            </div>
          ...
          <div class="w-full h-1.5 bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden shadow-inner">
            <div 
              ...
              :class="shohibul.collected >= shohibul.target ? 'bg-gradient-to-r from-green-400 to-emerald-400' : 'bg-gradient-to-r from-primary to-primary-light'"
...
import { UsersIcon, SearchIcon, InfoIcon, WalletIcon, XIcon, ActivityIcon, HistoryIcon, CheckCircleIcon, ClockIcon, MapPinIcon, PhoneIcon, ChevronRightIcon, UserPlusIcon, HomeIcon } from 'lucide-vue-next'
