<template>
  <div class="space-y-4 sm:space-y-5 pb-2" ref="containerRef">
    ...
    <div class="bg-gray-200/50 dark:bg-white/5 p-1.5 rounded-[1.2rem] flex tab-toggle w-full border border-gray-200/30 dark:border-white/5 relative shadow-inner">
      ...
      <div 
        class="absolute left-1.5 top-1.5 bottom-1.5 w-[calc(50%-0.375rem)] bg-white dark:bg-gray-800 border-[2px] border-gray-300 dark:border-white/10 rounded-xl shadow-md transition-transform duration-300 ease-out"
